...
our $CONFIG = {
  ...
  "Linux::DesktopFiles" => {
                             desktop_files_paths     => ["/usr/share/applications",
                                                        "$ENV{HOME}/.local/share/applications"],
                             gtk_rc_filename         => ["/home/bryanh/.gtkrc-2.0"],
                             icon_dirs_first         => ["/usr/share/icons/AwOkenWhite"],
                             icon_dirs_last          => ["/usr/share/pixmaps"],
                             icon_dirs_second        => [],
  ...
  "missing_icon"        => undef,
  "name_keys"           => ["Name"],
  "tmux"                => "terminator --geometry=1420x780 -e tmux",
  "terminal"            => "terminator --geometry=740x780",
